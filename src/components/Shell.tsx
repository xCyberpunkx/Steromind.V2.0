            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <div className="cursor-pointer transition-all hover:scale-105 active:scale-95">
                  <Avatar className="w-11 h-11 border border-primary/20 shadow-xl shadow-primary/10 rounded-2xl">
                    <AvatarImage src={user?.user_metadata?.avatar_url} />
                    <AvatarFallback className="gold-gradient text-white rounded-2xl">
